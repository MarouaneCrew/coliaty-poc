...
exports.ShipmentsModule = ShipmentsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [shipments_service_1.ShipmentsService, prisma_service_1.PrismaService, geocoding_service_1.GeocodingService, geocoding_queue_1.GeocodingQueue, shipments_analytics_1.ShipmentsAnalyticsService],
    })
], ShipmentsModule);
